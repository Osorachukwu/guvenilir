...
export default function AboutUs() {
    return (
        <div className='relative pt-20'>
            ...
            <div className='section-wrapper relative z-50'>
                <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-8'>
                    ...
                    {/*  */}
                    <div className='bg-primary/60 px-8 py-12 flex-1 text-center flex flex-col justify-center items-center hover:bg-transparent hover:border border-primary shadow'>
                        <ChartArea size={60} />
                    ...
                    <div className='bg-primary/80 px-8 py-12 flex-1 text-center flex flex-col justify-center items-center hover:bg-transparent hover:border border-primary shadow'>
                        <ChartArea size={60} />
