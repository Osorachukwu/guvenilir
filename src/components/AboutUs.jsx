        ...
        <div className='relative'>
            ...
            <div className='section-wrapper relative z-50 py-16 md:py-20'>
                <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-0 lg:gap-8'>
                    ...
                    {/*  */}
                    <div className='bg-primary/70 px-8 py-12 flex-1 text-center flex flex-col justify-center items-center hover:bg-transparent hover:border border-primary shadow' data-aos="fade-up" data-aos-delay="100">
                        <ChartArea size={60} />
                        <p className='text-4xl font-semibold my-6'>Trade An Asset</p>
                        <p className='font-semibold'>We offer various assets ranging from cryptocurrencies, to forex, commodities, indexes, stocks, ETFs, and the all new Pre-IPOs.</p>
                    </div>
                    <div className='bg-primary/90 px-8 py-12 flex-1 text-center flex flex-col justify-center items-center hover:bg-transparent hover:border border-primary shadow' data-aos="fade-up" data-aos-delay="200">
                        <ChartArea size={60} />
                        <p className='text-4xl font-semibold my-6'>Build A Portfolio</p>
                        <p className='font-semibold'>We also offer portfolios which allow you to invest in more than one asset class at a time. Portfolios are a great options if you want more.</p>
                    </div>
                </div>
            </div>
            {/*  */}
