  ...
  return (
    <div>
      ...
      <div className='mx-auto max-w-5xl py-10 md:py-16'>
        ...
        <p className='text-lg font-bold mb-4'>So how does it work?</p>

        <p className='text-lg font-bold mb-4'>Promote Glassdoor Holdingsings Limited Investmets</p>
        <p className='mb-10 leading-8'>
        ...
        <p className='text-lg font-bold mb-4'>Get affiliates & earn money</p>
        <p>
